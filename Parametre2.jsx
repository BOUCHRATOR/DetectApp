...
export default function Parametre2() {
 ...
 localStorage.clear();
  ...
  <div class="profile-card">
    <div class="profile-avatar">
      <img src={`http://localhost:8000/storage/${image}`} alt="User Avatar"></img>
    </div>

    <div class="profile-field">
      <input type="text" value="Bouchra" ></input>
    </div>

    <div class="profile-field">
      <input type="text" value="Tor" ></input>
    </div>
      <div class="profile-field">
      <input type="email" value="tor.bouchra1@gmail.com" ></input>
    </div>
    <div class="profile-field">
      <input type="text" value="0630173449" ></input>
    </div>

    <div class="profile-field">
      <input type="text" value="Nador"></input>
    </div>

    <div class="profile-field">
      <input type="text" value="19-09-2004" ></input>
    </div>
