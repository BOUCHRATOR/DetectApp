...
export default function Parametre() {
 ...
 localStorage.clear();
    ...
    <div className={`main-container ${!isSidebarOpen ? 'sidebar-closed' : ''}`}>
      <div className={`layout-left ${!isSidebarOpen ? 'collapsed' : ''}`}>
        ...
        <nav>
          ...
          <Link to="/Parametre" className="setting">
        ...
        {/* --- Contenu et tableau (inchangés) --- */}
         ...
         <div className="detection-wrapper">
          <div className="detection-card">
            <Link className="card" to="/parametre2"> 
  ...
  <path d="M8.256 14a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10q.39 0 .74.025c.226-.341.496-.65.804-.918Q8.844 9.002 8 9c-5 0-6 3-6 4s1 1 1 1z"/>
              ...
              <span className="text">  Information de profile</span>
            </Link>
            <Link className="card active" to="/securite">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="icon" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.8 11.8 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7 7 0 0 0 1.048-.625 11.8 11.8 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.54 1.54 0 0 0-1.044-1.263 63 63 0 0 0-2.887-.87C9.843.266 8.69 0 8 0m2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793z"/>
                </svg>
              <span className="text">  Identification et securite</span>
            </Link>
          </div>
          </div>
